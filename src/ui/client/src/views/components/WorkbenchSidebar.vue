...
import { Plus, Close, List, Picture as PictureIcon, DocumentAdd, Memo, Folder, ArrowDown, ArrowRight } from '@element-plus/icons-vue'
...
.wb-new-btn:hover { background: var(--tint-primary-12); color: var(--color-primary); }
...
.wb-task-item:hover { background: var(--bg-container-hover); border-color: transparent; }
.wb-task-item:hover .wb-task-item__del { opacity: 1; transform: translateX(0); }
.wb-task-item.active { background: color-mix(in srgb, var(--color-primary) 9%, var(--bg-container)); border-color: transparent; box-shadow: none; }
.wb-task-item.active::after {
  content: ''; position: absolute; left: -1px; top: 4px; bottom: 4px;
  width: 2px; border-radius: 2px; background: var(--color-primary);
...
.wb-task-item__del {
  ...
  cursor: pointer; font-size: 12px; flex-shrink: 0; opacity: 0; transform: translateX(-2px);
  transition: opacity var(--transition-fast) var(--ease-custom), background var(--transition-fast) var(--ease-custom), color var(--transition-fast) var(--ease-custom), transform var(--transition-fast) var(--ease-custom);
}
...
.wb-empty { padding: 22px 12px 18px; text-align: center; color: var(--text-tertiary); display: flex; flex-direction: column; align-items: center; gap: 4px; border-radius: var(--radius-md); background: var(--bg-subtle); }
.wb-empty--compact { padding: 10px 12px; flex-direction: row; justify-content: center; gap: 0; }
.wb-empty__art { width: 44px; height: 44px; border-radius: 12px; display: flex; align-items: center; justify-content: center; background: var(--tint-primary-12); color: var(--color-primary); font-size: 22px; margin-bottom: 2px; }
.wb-empty__title { font-size: 14px; font-weight: 600; letter-spacing: var(--letter-spacing-heading, -0.25px); color: var(--text-secondary); line-height: 1.4; }
.wb-empty--rich .wb-empty__hint { font-size: 12px; line-height: 1.55; color: var(--text-tertiary); max-width: 280px; }
.wb-empty__cta { display: flex; align-items: center; gap: 14px; margin-top: 6px; flex-wrap: wrap; justify-content: center; }
