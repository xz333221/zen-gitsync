...
- CLI 可能没装、或没在当前进程的 PATH 里(装完没重启服务就是这个表现):
...
- The CLI may not be installed, or missing from this process's PATH (that is what "installed but the
  server cannot find it" looks like):
