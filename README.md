...
| Per-file actions | Stage, unstage, or revert individual files from the file list |
...
A full IDE-like editor embedded in the GUI for browsing and editing project files without leaving the tool:
