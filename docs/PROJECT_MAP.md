...
│           ├── routes/            # 12 个 REST 路由注册器
│           │   ├── workbench.js        (3212 行, **最大**)
│           │   ├── config.js           (1207 行)
│           │   ├── npm.js              (1203 行)
│           │   ├── gitOps.js           (1179 行)
...
| 模块 | 文件数 | 行数 |
|------|------|------|
| **前端 .vue 总计** | 110+ | **53,629** |
| └ WorkbenchView.vue | 1 | 4,579 |
| └ CommandConsole.vue | 1 | 4,034 |
...
| **前端 .ts/.tsx** | 23 | **5,920** |
| **GUI 后端 .js** | 30 | **12,792** |
| └ routes/workbench.js | 1 | 3,212 |
| └ routes/config.js | 1 | 1,207 |
| └ routes/npm.js | 1 | 1,203 |
| └ routes/gitOps.js | 1 | 1,179 |
| **CLI 顶层 .js** | 5 | **2,031** |
| **i18n zh + en** | 2 | **4,077** |
| **总计核心代码** | ~170 | **~78,500** |
